...
class TestBasicPerformance:
    ...
    def test_health_endpoint_performance(self):
        ...
        if response_times:
            ...
            print(
                f"✅ Concurrent health requests: {len(successful_requests)}/20 successful"
            )
    ...
    def test_docs_endpoint_performance(self):
        ...
        if response_times:
            ...
            print(
                f"✅ Concurrent docs requests: {len(successful_requests)}/5 successful"
            )
            print(f"✅ Average response time: {statistics.mean(response_times):.3f}s")
    ...
    def test_openapi_endpoint_performance(self):
        ...
        if response_times:
            ...
            print(
                f"✅ Concurrent OpenAPI requests: {len(successful_requests)}/10 successful"
            )
            print(f"✅ Average response time: {statistics.mean(response_times):.3f}s")
...
class TestAIEndpointPerformance:
    ...
    def test_ai_suggestions_performance(self, mock_redis, mock_openai):
        ...
        print(
            f"✅ AI suggestions response time: {response_time:.3f}s (status: {status_code})"
        )
...
class TestAuthEndpointPerformance:
    ...
    def test_email_validation_performance(self):
        ...
        print(
            f"✅ Email validation response time: {response_time:.3f}s (status: {status_code})"
        )
        ...
        if response_times:
            ...
            print(
                f"✅ Concurrent email validation: {len(successful_requests)}/10 successful"
            )
            print(f"✅ Average response time: {statistics.mean(response_times):.3f}s")
...
def test_task_1_1_6_performance_tests():
    ...
    for test_class in test_classes:
        exit_code = pytest.main(
            [f"{__file__}::{test_class}", "-v", "-s", "--tb=short", "--maxfail=3"]
        )
