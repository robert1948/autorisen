...
class TestIntegrationWorkflows:
    ...
    def test_cape_ai_workflow(self):
        ...
        ai_request = {
            ...
            "context": {"page": "/test", "user_intent": "testing"},
    ...
    def test_complete_end_to_end_workflow(self):
        ...
        ai_request = {
            ...
            "context": {"page": "/integration-test", "user_intent": "complete_testing"},
            "conversation_id": conversation_id,
        }
        ...
        print(
            f"✅ Step 7: Conversation history (found {len(history.get('messages', []))} messages)"
        )
        ...
        if response.status_code == 200:
            ...
            print(
                f"⚠️  Step 8: Conversation cleanup not available (status: {response.status_code})"
            )
