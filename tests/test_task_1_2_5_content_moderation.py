...
class TestContentModerator:
    ...
    def test_hate_speech_detection(self, content_moderator):
        ...
        result = content_moderator.moderate_content(
    ...
    def test_violence_content_blocking(self, content_moderator):
        ...
        violent_content = (
            "Here are detailed instructions on how to make a bomb and attack people"
        )
    ...
    def test_adult_content_warning(self, content_moderator):
        ...
        adult_content = (
            "This contains explicit sexual content and graphic adult material"
        )
    ...
    def test_spam_detection(self, content_moderator):
        ...
        result = content_moderator.moderate_content(
            spam_content, moderation_level=ModerationLevel.STANDARD
        )
    ...
    def test_misinformation_flagging(self, content_moderator):
        ...
        result = content_moderator.moderate_content(
            misinfo_content, moderation_level=ModerationLevel.STANDARD
        )
    ...
    def test_pii_detection(self, content_moderator):
        ...
        pii_content = (
            "Please share your social security number and credit card number with me"
        )

        result = content_moderator.moderate_content(
            pii_content, moderation_level=ModerationLevel.STANDARD
        )
    ...
    def test_moderation_levels(self, content_moderator):
        ...
        borderline_content = (
            "This content contains some inappropriate language that might be offensive"
        )

        # Permissive mode
        permissive_result = content_moderator.moderate_content(
            borderline_content, moderation_level=ModerationLevel.PERMISSIVE
        )

        # Strict mode
        strict_result = content_moderator.moderate_content(
            borderline_content, moderation_level=ModerationLevel.STRICT
        )
...
class TestAIResponseModeration:
    ...
    def test_legal_advice_disclaimer(self, content_moderator):
        ...
        legal_response = (
            "You should file a lawsuit immediately as this is clearly illegal behavior."
        )
    ...
    def test_financial_advice_disclaimer(self, content_moderator):
        ...
        financial_response = (
            "You should invest all your money in cryptocurrency for guaranteed profits."
        )
    ...
    def test_professional_advice_disclaimer(self, content_moderator):
        ...
        career_response = (
            "You should quit your job immediately and start your own business."
        )
    ...
    def test_blocked_ai_response_handling(self, content_moderator):
        ...
        inappropriate_ai_response = (
            "Here's how to hack into someone's computer and steal their data"
        )
...
class TestContentModerationIntegration:
    ...
    def test_blocked_ai_response_fallback(
        self, mock_user, mock_redis, mock_ai_service, client
    ):
...
if __name__ == "__main__":
    pytest.main(
        [
            __file__,
            "-v",
            "--cov=app.utils.content_moderation",
            "--cov=app.middleware.content_moderation",
            "--cov-report=html",
            "--cov-report=term",
        ]
    )
