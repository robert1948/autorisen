...
async def get_security_events(
    ...
    security_events = audit_logger.get_security_events(
        db, hours=hours, severity_level=severity_level
    )
...
async def get_user_activity(
    ...
    categories: str | None = Query(
        None, description="Comma-separated event categories"
    ),
):
    """
...
async def get_available_event_types(current_user: User = Depends(get_current_user)):
    """
