...
class PasswordResetService:
    ...
    async def request_password_reset(self, db: Session, email: str) -> dict[str, Any]:
        ...
        try:
            ...
            expires_at = utc_now() + timedelta(seconds=self.reset_token_expiry)
            ...
            # Send reset email
            email_sent = await self.send_reset_email(
    ...
    async def _send_via_sendgrid(
        self, email: str, subject: str, text_content: str, html_content: str
    ) -> bool:
