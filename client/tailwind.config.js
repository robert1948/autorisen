...
export default {
  ...
  theme: {
    ...
    extend: {
      spacing: {
        '18': '4.5rem',    // 72px - useful for mobile touch targets
        '88': '22rem',     // 352px - useful for mobile containers
      ...
      animation: {
        ...
        fadeInDelay: 'fadeIn 1.0s ease-out 0.3s forwards',
        dropdown: 'dropdown 0.3s ease-out',
        slideUp: 'slideUp 0.5s ease-out',
        slideDown: 'slideDown 0.5s ease-out',
        bounceIn: 'bounceIn 0.6s ease-out',
        scaleIn: 'scaleIn 0.3s ease-out',
        mobileTap: 'mobileTap 0.1s ease-out'
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0', transform: 'translateY(10px)' },
